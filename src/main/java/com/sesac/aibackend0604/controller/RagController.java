...
import com.sesac.aibackend0604.dto.ChatResponse;
import com.sesac.aibackend0604.dto.RagChatRequest;
import com.sesac.aibackend0604.dto.RagIngestResponse;
import com.sesac.aibackend0604.service.ChatLogService;
import com.sesac.aibackend0604.service.PythonRagClient;
...
public class RagController {
    ...
    public RagIngestResponse ingest(
        ...
        log.debug("rag ingest by {}: {} ({} bytes)", user.getUsername(), file.getOriginalFilename(), file.getName());
